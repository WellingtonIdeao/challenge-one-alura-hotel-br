...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/br/com/ideao/alurahotel/imagens/img-hotel-login-.png")));
		...
		logo.setIcon(new ImageIcon(Login.class.getResource("/br/com/ideao/alurahotel/imagens/lOGO-50PX.png")));
