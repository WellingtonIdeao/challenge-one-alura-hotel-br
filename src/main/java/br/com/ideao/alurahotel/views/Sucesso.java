...
public class Sucesso extends JDialog {
	 ...
	 */
	public Sucesso() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Sucesso.class.getResource("/br/com/ideao/alurahotel/imagens/aH-40px.png")));
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Sucesso.class.getResource("/br/com/ideao/alurahotel/imagens/Ha-100px.png")));
