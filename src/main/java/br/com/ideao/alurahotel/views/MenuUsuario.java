...
public class MenuUsuario extends JFrame {
	 ...
	 */
	public MenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource("/br/com/ideao/alurahotel/imagens/aH-40px.png")));
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource("/br/com/ideao/alurahotel/imagens/pessoas.png")));
		...
		panelMenu.add(logo);
		logo.setIcon(new ImageIcon(MenuUsuario.class.getResource("/br/com/ideao/alurahotel/imagens/aH-150px.png")));
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource("/br/com/ideao/alurahotel/imagens/reservado.png")));
